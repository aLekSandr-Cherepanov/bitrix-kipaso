				...
				<div class="productColText">
					...
					<?if(!empty($arResult["PRICE"])):?>
						...
						<div class="addCartContainer">
							<a href="#" class="addCart<?if($arResult["CATALOG_AVAILABLE"] != "Y"):?> disabled<?endif;?>" data-refresh-page="<?=$arParams["REFRESH_PAGE"];?>" data-display-window="N" data-cart-label="<?=GetMessage("GIFT_ADD_LABEL")?>" data-id="<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/addGift.svg" alt="" class="icon"><?=GetMessage("GIFT_ADDCART_LABEL")?></a>
						</div>
					...
					<?else:?>
						...
						<div class="addCartContainer"><a href="#" class="addCart disabled requestPrice" data-refresh-page="<?=$arParams["REFRESH_PAGE"];?>" data-display-window="N" data-cart-label="<?=GetMessage("GIFT_ADD_LABEL")?>" data-id="<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/request.svg" alt="" class="icon"><?=GetMessage("REQUEST_PRICE_BUTTON_LABEL")?></a></div>
					<?endif;?>
				</div>
			</div>
			<div class="optional">

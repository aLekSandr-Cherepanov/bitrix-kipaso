...
$MESS["SOA_SUM_SUMMARY_WITHOUT_DISCOUNT"] = "Сумма без скидки:";
...
$MESS["REGION_BLOCK_NAME_DEFAULT"] = "Выберите тип плательщика";
$MESS["PAYMENT_BLOCK_NAME_DEFAULT"] = "Выберите способ оплаты";
$MESS["DELIVERY_BLOCK_NAME_DEFAULT"] = "Выберите доставку";
...
$MESS["PRICE_FREE_INDIVIDUAL"] = "Индивидуальный расчёт";
$MESS["PRICE_FREE_PICKUP"] = "Самовывоз";
...
$MESS["USE_COUPON_DEFAULT"] = "<span class=\"coupon_head\">Есть промокод на скидку?</span><span class='coupon_desc'>Введите промокод для применения скидок</span>";
$MESS["COUPON_PLACEHOLDER"] = "Введите промокод";
$MESS["COUPON_DEFAULT"] = "Купон";
$MESS["COUPON_USE"] = "Применить";
...
$MESS["CONTENTS_BASKET"] = "Содержимое корзины";
$MESS["PICKUP_NAME"] = "Выберите пункт самовывоза";
$MESS["MIN_SUM_TO_PAYMENT_TITLE"] = "Минимальная сумма заказа";
$MESS["ADDED_TO_ORDER"] = "Дополнить заказ";
$MESS["CONFIRM_TITLE"] = "Заказ успешно создан";
$MESS["NUMBER_ORDER"] = "Номер заказа:";
$MESS["THANKS_ORDER"] = "Спасибо за Ваш заказ";
$MESS["CALCULATE"] = "Рассчитать"
?>

...
$this->addExternalJs($templateFolder.'/scripts/masked.min.js');
...
if ($useDefaultMessages || !isset($arParams['MESS_AUTH_BLOCK_NAME']))
{
	...
	$arParams['MESS_AUTH_BLOCK_NAME'] = htmlspecialchars_decode($arParams['MESS_AUTH_BLOCK_NAME']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_REG_BLOCK_NAME']))
{
	...
	$arParams['MESS_REG_BLOCK_NAME'] = htmlspecialchars_decode($arParams['MESS_REG_BLOCK_NAME']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_BASKET_BLOCK_NAME']))
{
	...
	$arParams['MESS_BASKET_BLOCK_NAME'] = htmlspecialchars_decode($arParams['MESS_BASKET_BLOCK_NAME']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_REGION_BLOCK_NAME']))
{
	...
	$arParams['MESS_REGION_BLOCK_NAME'] = htmlspecialchars_decode($arParams['MESS_REGION_BLOCK_NAME']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_PAYMENT_BLOCK_NAME']))
{
	...
	$arParams['MESS_PAYMENT_BLOCK_NAME'] = htmlspecialchars_decode($arParams['MESS_PAYMENT_BLOCK_NAME']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_DELIVERY_BLOCK_NAME']))
{
	...
	$arParams['MESS_DELIVERY_BLOCK_NAME'] = htmlspecialchars_decode($arParams['MESS_DELIVERY_BLOCK_NAME']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_BUYER_BLOCK_NAME']))
{
	...
	$arParams['MESS_BUYER_BLOCK_NAME'] = htmlspecialchars_decode($arParams['MESS_BUYER_BLOCK_NAME']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_BACK']))
{
	...
	$arParams['MESS_BACK'] = htmlspecialchars_decode($arParams['MESS_BACK']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_FURTHER']))
{
	...
	$arParams['MESS_FURTHER'] = htmlspecialchars_decode($arParams['MESS_FURTHER']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_EDIT']))
{
	...
	$arParams['MESS_EDIT'] = htmlspecialchars_decode($arParams['MESS_EDIT']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_ORDER']))
{
	...
	$arParams['MESS_ORDER'] = htmlspecialchars_decode($arParams['MESS_ORDER']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_PRICE']))
{
	...
	$arParams['MESS_PRICE'] = htmlspecialchars_decode($arParams['MESS_PRICE']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_PERIOD']))
{
	...
	$arParams['MESS_PERIOD'] = htmlspecialchars_decode($arParams['MESS_PERIOD']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_NAV_BACK']))
{
	...
	$arParams['MESS_NAV_BACK'] = htmlspecialchars_decode($arParams['MESS_NAV_BACK']);
}
...
{
	$arParams['CALCULATE'] = Loc::getMessage('CALCULATE');
} else {
	$arParams['CALCULATE'] = htmlspecialchars_decode($arParams['CALCULATE']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_ECONOMY']))
{
	...
	$arParams['MESS_ECONOMY'] = htmlspecialchars_decode($arParams['MESS_ECONOMY']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_REGISTRATION_REFERENCE']))
{
	...
	$arParams['MESS_REGISTRATION_REFERENCE'] = htmlspecialchars_decode($arParams['MESS_REGISTRATION_REFERENCE']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_AUTH_REFERENCE_1']))
{
	...
	$arParams['MESS_AUTH_REFERENCE_1'] = htmlspecialchars_decode($arParams['MESS_AUTH_REFERENCE_1']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_AUTH_REFERENCE_2']))
{
	...
	$arParams['MESS_AUTH_REFERENCE_2'] = htmlspecialchars_decode($arParams['MESS_AUTH_REFERENCE_2']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_AUTH_REFERENCE_3']))
{
	...
	$arParams['MESS_AUTH_REFERENCE_3'] = htmlspecialchars_decode($arParams['MESS_AUTH_REFERENCE_3']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_ADDITIONAL_PROPS']))
{
	...
	$arParams['MESS_ADDITIONAL_PROPS'] = htmlspecialchars_decode($arParams['MESS_ADDITIONAL_PROPS']);
}

if ($useDefaultMessages || !isset($arParams['COUPON_PLACEHOLDER']))
{
	$arParams['COUPON_PLACEHOLDER'] = Loc::getMessage('COUPON_PLACEHOLDER');
} else {
	$arParams['COUPON_PLACEHOLDER'] = htmlspecialchars_decode($arParams['COUPON_PLACEHOLDER']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_USE_COUPON']))
{
	...
	$arParams['MESS_USE_COUPON'] = htmlspecialchars_decode($arParams['MESS_USE_COUPON']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_COUPON']))
{
	...
	$arParams['MESS_COUPON'] = htmlspecialchars_decode($arParams['MESS_COUPON']);
}

if ($useDefaultMessages || !isset($arParams['MESS_COUPON_USE']))
{
	$arParams['MESS_COUPON_USE'] = Loc::getMessage('COUPON_USE');
} else {
	$arParams['MESS_COUPON_USE'] = htmlspecialchars_decode($arParams['MESS_COUPON_USE']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_PERSON_TYPE']))
{
	...
	$arParams['MESS_PERSON_TYPE'] = htmlspecialchars_decode($arParams['MESS_PERSON_TYPE']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_SELECT_PROFILE']))
{
	...
	$arParams['MESS_SELECT_PROFILE'] = htmlspecialchars_decode($arParams['MESS_SELECT_PROFILE']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_REGION_REFERENCE']))
{
	...
	$arParams['MESS_REGION_REFERENCE'] = htmlspecialchars_decode($arParams['MESS_REGION_REFERENCE']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_PICKUP_LIST']))
{
	...
	$arParams['MESS_PICKUP_LIST'] = htmlspecialchars_decode($arParams['MESS_PICKUP_LIST']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_NEAREST_PICKUP_LIST']))
{
	...
	$arParams['MESS_NEAREST_PICKUP_LIST'] = htmlspecialchars_decode($arParams['MESS_NEAREST_PICKUP_LIST']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_SELECT_PICKUP']))
{
	...
	$arParams['MESS_SELECT_PICKUP'] = htmlspecialchars_decode($arParams['MESS_SELECT_PICKUP']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_SELECTED_PICKUP']))
{
	...
	$arParams['MESS_SELECTED_PICKUP'] = htmlspecialchars_decode($arParams['MESS_SELECTED_PICKUP']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_INNER_PS_BALANCE']))
{
	...
	$arParams['MESS_INNER_PS_BALANCE'] = htmlspecialchars_decode($arParams['MESS_INNER_PS_BALANCE']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_ORDER_DESC']))
{
	...
	$arParams['MESS_ORDER_DESC'] = htmlspecialchars_decode($arParams['MESS_ORDER_DESC']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_PRELOAD_ORDER_TITLE']))
{
	...
	$arParams['MESS_PRELOAD_ORDER_TITLE'] = htmlspecialchars_decode($arParams['MESS_PRELOAD_ORDER_TITLE']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_SUCCESS_PRELOAD_TEXT']))
{
	...
	$arParams['MESS_SUCCESS_PRELOAD_TEXT'] = htmlspecialchars_decode($arParams['MESS_SUCCESS_PRELOAD_TEXT']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_FAIL_PRELOAD_TEXT']))
{
	...
	$arParams['MESS_FAIL_PRELOAD_TEXT'] = htmlspecialchars_decode($arParams['MESS_FAIL_PRELOAD_TEXT']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_DELIVERY_CALC_ERROR_TITLE']))
{
	...
	$arParams['MESS_DELIVERY_CALC_ERROR_TITLE'] = htmlspecialchars_decode($arParams['MESS_DELIVERY_CALC_ERROR_TITLE']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_DELIVERY_CALC_ERROR_TEXT']))
{
	...
	$arParams['MESS_DELIVERY_CALC_ERROR_TEXT'] = htmlspecialchars_decode($arParams['MESS_DELIVERY_CALC_ERROR_TEXT']);
}
...
if ($useDefaultMessages || !isset($arParams['MESS_PAY_SYSTEM_PAYABLE_ERROR']))
{
	...
	$arParams['MESS_PAY_SYSTEM_PAYABLE_ERROR'] = htmlspecialchars_decode($arParams['MESS_PAY_SYSTEM_PAYABLE_ERROR']);
}

if ($useDefaultMessages || !isset($arParams['PICKUP_NAME']))
{
	$arParams['PICKUP_NAME'] = Loc::getMessage('PICKUP_NAME');
} else {
	$arParams['PICKUP_NAME'] = htmlspecialchars_decode($arParams['PICKUP_NAME']);
}

if ($useDefaultMessages || !isset($arParams['MIN_SUM_TO_PAYMENT_TITLE']))
{
	$arParams['MIN_SUM_TO_PAYMENT_TITLE'] = Loc::getMessage('MIN_SUM_TO_PAYMENT_TITLE');
}

if ($useDefaultMessages || !isset($arParams['ADDED_TO_ORDER']))
{
	$arParams['ADDED_TO_ORDER'] = Loc::getMessage('ADDED_TO_ORDER');
}
...
else
{
	...
	global $arTemplateSettings;
	?>
	<div class="theme-<?=$arTemplateSettings["TEMPLATE_THEME_NAME"]?>"<?if(!empty($arParams["COLOR_THEME"])):?> style="--color-theme: <?=$arParams["COLOR_THEME"]?>"<?endif;?> >
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" <?if($arParams["REDEFINE_THEME"] === 'Y' && empty($arParams["COLOR_THEME"])):?>class="bx-<?=$arParams['TEMPLATE_THEME']?>"<?endif;?> style="opacity: 0">
			<!--	MAIN BLOCK	-->			
			<div class="bx-soa">
				...
				<div id="bx-soa-auth" class="bx-soa-section bx-soa-auth" style="display:none">
					<div class="bx-soa-section-title-container">
						<h2 class="bx-soa-section-title"><?=$arParams['MESS_AUTH_BLOCK_NAME']?></h2>
					</div>
				...
				<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
					<!--	BASKET ITEMS BLOCK	-->
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active<?if($arParams['SHOW_BASKET'] !== 'Y'):?> hidden<?endif;?>">
						<div class="bx-soa-section-title-container">
				...
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container">
						<h2 class="bx-soa-section-title"><?=$arParams['MESS_REGION_BLOCK_NAME']?></h2>
			...
			<div id="bx-soa-orderSave" <?if($arParams["ALLOW_AUTO_REGISTER"] !== 'Y' && !$arResult['JS_DATA']["IS_AUTHORIZED"]):?>class="hidden"<?endif;?>>
				<div class="checkbox"><?
	...
	$arLocs = CSaleLocation::GetByID($_SESSION["USER_GEO_POSITION"]["locationID"], LANGUAGE_ID);
	$locationCode = $arLocs["CODE"];
	?>
	<script>
		BX.Currency.setCurrencyFormat('<?=$arResult["BASE_LANG_CURRENCY"]?>', <?=CUtil::PhpToJSObject($currencyFormat, false, true); ?>);
		...
		BX.Sale.OrderAjaxComponent.init({
			...
			locationIDByIP: '<?=GeoIp::getLocationCode(\Bitrix\Main\Service\GeoIp\Manager::getRealIp());?>',
...
// 	$APPLICATION->AddChainItem(Loc::getMessage('CONTENTS_BASKET'), $arParams['PATH_TO_BASKET']);
// }

// $APPLICATION->AddChainItem($APPLICATION->GetTitle());
?>
<script>var _topMenuNoFixed = true;//deluxe template header menu no fixed</script>

<?if($arParams["REDEFINE_THEME"] === 'Y' && !empty($arParams["COLOR_THEME"])):?>
<style>
	/* sale.order.ajax */
...
.btn-simple.btn-border:hover {
	color: <?=$arParams["COLOR_THEME"]?>;
}

#bx-soa-order-form .soa-property-files > .btn.btn-default {
	color: <?=$arParams["COLOR_THEME"]?> !important;
}
...
.btn-simple:hover:not(.btn-border) {
	background-color: <?=$arParams["COLOR_THEME"]?>;
}

.bx-soa-coupon-input:after,
.bx-soa label.btn-person-type-checked {
	background-color: <?=$arParams["COLOR_THEME"]?> !important;
}
...
.btn-simple:hover,
.btn-simple.btn-border:hover {
	border-color: <?=$arParams["COLOR_THEME"]?>;
}

#bx-soa-order-form .btn.btn-default,
.bx-soa label.btn-person-type-checked {
	border-color: <?=$arParams["COLOR_THEME"]?> !important;
}
/* /sale.order.ajax */
</style>
<?endif;?>
